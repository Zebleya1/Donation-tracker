...
function getStatus() {
    ...
    axios
        ...
        .then((response) => {
            ...
            document.getElementById("statusElement").textContent = "Status: Data updated";
        ...
        .catch((error) => {
            ...
            document.getElementById("statusElement").textContent = "Status: Error fetching data";
            document.getElementById("raisedAmount").textContent = lastKnownRaisedAmount;
